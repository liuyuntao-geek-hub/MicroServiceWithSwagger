CREATE EXTERNAL TABLE IF NOT EXISTS ts_pdphpipph_nogbd_r000_wh.mtclm(
...
stored as parquet
location  'hdfs://nameservice1/ts/hdfsdata/ve2/pdp/hpip/phi/no_gbd/r000/warehouse/mtclm';

CREATE EXTERNAL TABLE IF NOT EXISTS ts_pdphpipph_nogbd_r000_wh.mtclm_coa(
clm_adjstmnt_key string , 
clm_line_nbr string , 
inpat_cd string , 
mbu_cf_cd string , 
...
partitioned by(clm_sor_cd string )
stored as parquet
location  'hdfs://nameservice1/ts/hdfsdata/ve2/pdp/hpip/phi/no_gbd/r000/warehouse/mtclm_coa';