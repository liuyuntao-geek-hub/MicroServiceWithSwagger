...
object FirstSpliceSparkNoEncrypt extends Logging {
...
/*    
    ...
    val endTime = DateTime.now
		 info(" [COE 2.0 Splice Spark Adapter no Encrypt] Start Time: "+ startTime);
		 info(" [COE 2.0 Splice Spark Adapter no Encrypt] End Time: " + endTime)
     println(" [COE 2.0 Splice Spark Adapter no Encrypt] Minutes diff: " + Minutes.minutesBetween(startTime, DateTime.now()).getMinutes + " mins.")
     info (" [COE 2.0 Splice Spark Adapter no Encrypt] Seconds Diff: " + Seconds.secondsBetween(startTime, endTime).getSeconds + " seconds. ")
  	
     println(" [COE 2.0 Splice Spark Adapter no Encrypt] Start Time: "+ startTime);
		 println(" [COE 2.0 Splice Spark Adapter no Encrypt] End Time: " + endTime)   
     println (" [COE 2.0 Splice Spark Adapter no Encrypt] Seconds Diff: " + Seconds.secondsBetween(startTime, endTime).getSeconds + " seconds. ")
