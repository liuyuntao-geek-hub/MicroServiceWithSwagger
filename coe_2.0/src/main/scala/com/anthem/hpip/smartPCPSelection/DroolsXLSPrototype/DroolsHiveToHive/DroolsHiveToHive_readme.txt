...
--master yarn \
--deploy-mode cluster \
--name Drools-HiveDFToHive-hdfs-cluster-1GB-SPARK22 \
--driver-cores 5 \
--driver-memory 8G \
--num-executors 50 \
--executor-memory 20G \
...
--class com.anthem.hpip.smartPCPSelection.DroolsXLSPrototype.DroolsHiveToHive.DroolsHiveToHiveDriver \
hdfs:///dv/hdfsapp/ve2/pdp/spfi/phi/no_gbd/r000/bin/CenterOfExcellence-2.0.0.jar \
hdfs:///dv/hdfsapp/ve2/pdp/spfi/phi/no_gbd/r000/control/ dev_coe smartProviderCoe_v1
...
https://dwbdtest1r1m.wellpoint.com:8090/cluster/app/application_1527038069742_10204
