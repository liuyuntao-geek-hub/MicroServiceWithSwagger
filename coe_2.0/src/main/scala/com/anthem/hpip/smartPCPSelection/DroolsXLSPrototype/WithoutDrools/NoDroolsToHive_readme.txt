...
--class com.anthem.hpip.smartPCPSelection.DroolsXLSPrototype.WithoutDrools.NoDroolsToHiveDriver \
...
--master yarn \
--deploy-mode cluster \
--name NoDrools-ToHive-cluster-SPARK22 \
--driver-cores 5 \
--driver-memory 8G \
--num-executors 50 \
--executor-memory 20G \
...
--master yarn \
--deploy-mode cluster \
--name NoDrools-DFListToHive-hdfs-cluster-20M-SPARK22 \
--driver-cores 5 \
--driver-memory 8G \
--num-executors 50 \
--executor-memory 20G \
