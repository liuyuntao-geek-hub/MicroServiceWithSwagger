...
public class KieSessionFactory  implements Serializable {
    ...
    public static StatelessKieSession getKieSessionFromFile (File file) {
        if (statelessKieSession == null)
            statelessKieSession = getNewKieSessionFromFile(file);
        return statelessKieSession;
    }

    public static StatelessKieSession getNewKieSessionFromFile (File file) {
        System.out.println("creating a new kie session");
     ...
     //  File drlFile = new File(file);
        Resource resource = kieResources.newFileSystemResource(file);
        kieFileSystem.write(resource);
