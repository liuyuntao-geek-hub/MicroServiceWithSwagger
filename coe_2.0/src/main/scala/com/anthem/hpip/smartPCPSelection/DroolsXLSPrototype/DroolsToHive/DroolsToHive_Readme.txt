...
{project_path}/ddl/dev/DroolsPOC.txt
	- create dv_pdpspfiph_nogbd_r000_wh.zz_product_discount
...
Step 2 - Test run Spark:
	...
	Parameters: C:\java\git\repos\coe_2.0\conf local TemplateLocal
===============================================================
...
Step 5 - Setup circle time:
	query_smartProviderCoe.properties
...
--class com.anthem.hpip.smartPCPSelection.DroolsXLSPrototype.DroolsToHive.DroolsToHiveDriver \
...
--master yarn \
--deploy-mode cluster \
--name Drools-ListDFToHive-hdfs-cluster-10M-SPARK22 \
--driver-cores 5 \
--driver-memory 8G \
--num-executors 50 \
--executor-memory 20G \
...
select count (*) from   dv_pdpspfiph_nogbd_r000_wh.zz_product_discount;

select * from   dv_pdpspfiph_nogbd_r000_wh.zz_product_discount limit 100;
