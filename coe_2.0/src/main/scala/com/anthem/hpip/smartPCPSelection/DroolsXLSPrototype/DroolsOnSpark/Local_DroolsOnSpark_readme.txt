...
--master yarn \
--deploy-mode client \
--name Drools-SimpleTest-client-SPARK22 \
--driver-cores 5 \
--driver-memory 8G \
--num-executors 50 \
--executor-memory 20G \
...
--class com.anthem.hpip.smartPCPSelection.DroolsXLSPrototype.DroolsOnSpark.DroolsProductDriver \
...
--master yarn \
--deploy-mode cluster \
--name Drools-hdfs-cluster-SPARK22 \
--driver-cores 5 \
--driver-memory 8G \
--num-executors 50 \
--executor-memory 20G \
