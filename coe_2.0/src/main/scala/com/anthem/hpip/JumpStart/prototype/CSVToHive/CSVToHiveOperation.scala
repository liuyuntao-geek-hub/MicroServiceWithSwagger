...
//var dataMap = Map("zz_phmp_customer"->newTestDF)
   var dataMap = Map("zz_phmp_customer"->newTestDF, "zz_phmp_mtclm_out"->loadHiveTableData())
  ...
  def processData(inDFs: Map[String, DataFrame]): Map[String, DataFrame] = {
    ...
    val df2 = inDFs.getOrElse("zz_phmp_mtclm_out", null)
  ...
  //  var dataMap = Map("zz_phmp_customer"->df1WithAuditColumn)
    ...
    var dataMap = Map("zz_phmp_customer"->df1WithAuditColumn, "zz_phmp_mtclm_out"->df2WithAuditColumn)
    return dataMap
  }
  ...
  def writeData(outDFs: Map[String, DataFrame]): Unit = {
    ...
    val df2 = outDFs.getOrElse("zz_phmp_mtclm_out", null)
    df1.show()
    df2.show()
