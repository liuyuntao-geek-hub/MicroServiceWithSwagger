...
spark-submit --name "FirstRun" --master yarn-client  --class com.deloitte.demo.DroolsXLSPrototype.DroolsProductDriver OldSparkScala.jar DroolsPrototype yarn-client
