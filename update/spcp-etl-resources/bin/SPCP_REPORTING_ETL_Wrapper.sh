...
# Description      : Shell Script for spark reporting ETL
# Developer        : Anthem
# Created on       : JUNE 2017
# Location         : INDIA
# Date           Auth           Ver#     Modified By(Name)                 Change and Reason for Change
# ----------    -----        -----------------------------               --------------------------------------
# 2018/10/26    Deloitte         1     Initial Version
#====================================================================================================================================================
##  INPUT ARGUMENTS                                                                                     
...
spark2-submit --class com.anthem.hca.spcp.reporting.ReportingDriver --master yarn --deploy-mode cluster \
--queue $QUEUE_NAME \
