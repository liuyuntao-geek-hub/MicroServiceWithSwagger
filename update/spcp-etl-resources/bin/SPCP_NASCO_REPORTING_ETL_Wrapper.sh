...
source ~/.bash_profile
#=================================================================================================================================================
# Title            : REPORTING_ETL_WRAPPER
# ProjectName      : 849 SMARTPCP
# Filename         : REPORTING_ETL_Wrapper.sh
# Description      : Shell Script for spark NASCO reporting ETL
# Developer        : Anthem
# Created on       : DEC 2018
# Location         : INDIA
# Date           Auth           Ver#     Modified By(Name)                 Change and Reason for Change
# ----------    -----        -----------------------------               --------------------------------------
# 2018/12/03    Deloitte         1     Initial Version
#====================================================================================================================================================
##  INPUT ARGUMENTS                                                                                     
...
#==================================================================================================================================================== 
## SAMPLE ARGUMENTS
#subject_area='spcp-etl-reporting'
#Environment='dev'
...
SUBJECT_AREA="spcp-etl-nasco-reporting"
...
spark2-submit --class com.anthem.hca.spcp.nascoreport.NascoReportDriver --master yarn --deploy-mode cluster \
--queue $QUEUE_NAME \
