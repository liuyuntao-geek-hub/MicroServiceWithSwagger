...
source ~/.bash_profile
#=================================================================================================================================================
# Title            : VARIANCE_WRAPPER
# ProjectName      : 849 SMARTPCP select 
# Filename         : VARIANCE_Wrapper.sh
# Description      : Shell Script for spark Variance ETL
# Developer        : Anthem
...
SUBJECT_AREA="spcp-etl-Variance"
...
spark2-submit --class com.anthem.hca.spcp.variance.VarianceDriver --master yarn --deploy-mode cluster \
--queue $QUEUE_NAME \
...
--name $SUBJECT_AREA  $JAR_FILE_PATH/$JAR_NAME $CONFIG_PATH $ENV $QUERY_PROPERTY $TABLE_NM
#=====================================================================================================================================================
