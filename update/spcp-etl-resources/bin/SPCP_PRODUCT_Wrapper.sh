...
export JAVA_HOME=/usr/java/latest
 spark2-submit --queue splice_yarn --class com.anthem.hca.spcp.product.ProductDriver --master yarn --deploy-mode cluster \
--queue $QUEUE_NAME \
