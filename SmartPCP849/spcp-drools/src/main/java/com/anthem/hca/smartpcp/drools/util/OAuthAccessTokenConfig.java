...
public class OAuthAccessTokenConfig {
	...
	private HttpEntity<MultiValueMap<String, String>> buildRequestForAccessToekn() {
		return new HttpEntity<>(setRequestParam(), buildHttpHeaders(BASIC, encodeClientCredentials(), MediaType.APPLICATION_FORM_URLENCODED));
	}
