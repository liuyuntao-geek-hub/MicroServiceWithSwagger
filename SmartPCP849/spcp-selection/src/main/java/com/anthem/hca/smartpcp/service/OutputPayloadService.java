...
public class OutputPayloadService {
	 ...
	 * @return OutputPayload
	 */
	public OutputPayload createSuccessPaylod(String reportingCode,String reportingText, Member member, boolean dummyFlag,
			Provider validPCP) {
		...
		if (dummyFlag) {
			...
			LOGGER.info("PCP Assigned provPcpId={}, network={}, dummy={}", validPCP.getProvPcpId(), validPCP.getRgnlNtwkId(), dummyFlag);
		}
