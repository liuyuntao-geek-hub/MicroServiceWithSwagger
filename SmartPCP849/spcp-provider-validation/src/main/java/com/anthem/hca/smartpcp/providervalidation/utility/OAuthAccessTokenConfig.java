...
import com.anthem.hca.smartpcp.providervalidation.service.RestClientService;
...
public class OAuthAccessTokenConfig {
	private static final Logger LOGGER =LoggerFactory.getLogger(OAuthAccessTokenConfig.class);
	...
	private HttpHeaders buildHttpHeaders(String authType, String authValue, MediaType mediaType) {
		LOGGER.debug("Invoking the transaction service API_KEY =="+ apiKey);		
