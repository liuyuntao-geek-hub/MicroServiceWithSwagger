...
public class PCP {
	...
	/**
	 * @param pcpLastNm the pcpLastNm to set
	 */
	...
	public void setRgnlNtwkId(String rgnlNtwkId) {
		this.rgnlNtwkId = rgnlNtwkId.trim();
	}
	/**
	 * @return the tierLvl
	 */
	...
	public void setPcpRankgId(String pcpRankgId) {
		this.pcpRankgId = pcpRankgId.trim();
	}
	/**
	...
	/**
	 * @param pEndDate the grpgRltdPadrsTrmntnDt to set
	 */
	public void setGrpgRltdPadrsTrmntnDt(java.util.Date pEndDate) {
		this.grpgRltdPadrsTrmntnDt = pEndDate;
	}
	/**
