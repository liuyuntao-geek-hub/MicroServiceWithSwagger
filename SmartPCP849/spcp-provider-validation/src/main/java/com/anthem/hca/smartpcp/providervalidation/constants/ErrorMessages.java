 ...
 * @author AF69961
 */
 package com.anthem.hca.smartpcp.providervalidation.constants;
...
public class ErrorMessages {
	...
	public static final String MISSING_INVOCATION_SYSTEM = "MISSING_INVOCATION_SYSTEM";
			...
			public static final String MISSING_LONGITUDE = "MISNG_LONGITUDE";
			...
			public static final String INVALID_MBR_FIRST_NAME = "INVALID_FIRST_NAME";
			public static final String INVALID_MBR_MIDDLE_NAME = "INVALID_MIDDLE_NAME";
			public static final String INVALID_MBR_LAST_NAME = "INVALID_LAST_NAME";

			public static final String INVALID_ROLLOVER_PCPID = "INVALID_ROLL_OVER_PCPID";
			public static final String INVALID_MBR_PREGNANCY_INDICATOR = "INVALID_PREGNANCY_INDICATOR";

			public static final String MISSING_MBR_EFFECTIVE_DATE = "MISSING_EFFECTIVE_DATE";
			public static final String INVALID_MBR_EFFECTIVE_DATE = "INVALID_EFFECTIVE_DATE";
			...
			public static final String AUDIT_TABLE_FAIL = "AUDIT_FAIL";
			public static final String INVALID_BING_RESP = "BING_ERR";
			public static final String INVALID_DROOLS_RESP = "DROOLS_INVCTN_ERR";
			
			public static final String MISSING_DROOLS_PRIMARY_SPLTY = "MISSING_DROOLS_PRIMARY_SPLTY";
			public static final String INVALID_DROOLS_PRIMARY_SPLTY = "INVALID_DROOLS_PRIMARY_SPLTY";
			...
			public static final String MISSING_DROOLS_DISTANCE = "MISSING_DROOLS_DISTANCE";
