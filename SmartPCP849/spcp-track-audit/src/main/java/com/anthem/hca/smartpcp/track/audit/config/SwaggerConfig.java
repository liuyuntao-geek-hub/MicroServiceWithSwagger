package com.anthem.hca.smartpcp.track.audit.config;
...
public class SwaggerConfig {
	...
	public Docket docket(){
		...
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apiInfo(apiInfo())
				.pathMapping("/spcp-track-audit")
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.anthem.hca.smartpcp.track.audit.controller"))
