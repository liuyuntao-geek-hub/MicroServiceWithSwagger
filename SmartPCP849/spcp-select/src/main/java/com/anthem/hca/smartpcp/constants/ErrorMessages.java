...
public class ErrorMessages {
	...
	public static final String INVALID_MBR_TERMINATION_DATE = "INVALID_MBR_TERMINATION_DATE";
	
	public static final String INVALID_UPDATE_COUNTER = "INVALID_UPDATE_COUNTER";
	...
	public static final String APIGEE_SERVICE_TOKEN_UNAVAILABLE = "APIGEE_SERVICE_TOKEN_UNAVAILABLE";
	
	
	public static final String NO_VALID_PCP = "NO_VALID_PCP";
	
	public static final String MARKET_NOT_CONFIGURED = "EPS_NEED_TO_PROCESS";
