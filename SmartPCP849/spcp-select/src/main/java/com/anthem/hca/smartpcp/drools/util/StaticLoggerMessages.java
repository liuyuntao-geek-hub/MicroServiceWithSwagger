...
/**
 * The StaticLoggerMessages class is used to store all Logger Messages
...
public class StaticLoggerMessages {
	...
	public static final String RULES_EXIT_MSG_MDOPOOL_PROVAL = "Rules extracted for MDO Build Pool and Provider Validation";
	...
	/**
	 * Private Constructor for StaticLoggerMessages.
	 * 
	 * @param None
	 */
