...
/**
 * The AffinityProviderValidationService class is the Service Layer implementation of
 * Provider Validation Rules for Affinity. It invokes the DroolsService to fire the
 * specific Rules and returns a Rules object containing all the parameters for Affinity Provider Validation.
 *
...
public class AffinityProviderValidationService implements IRulesService {
	...
	/**
	 * This method takes a Member payload as the parameter and runs the Affinity
	...
	public ProviderValidationRules getRules(Member payload) throws DroolsParseException, JsonProcessingException {
		AbstractRules rules = RulesFactory.createRule(AgendaGroup.AFFINITY_PROVIDER_VALIDATION);	// Create a Rule of type Affinity Provider Validation
		...
		operationAuditFlowService.insertOperationFlowDrools(AgendaGroup.AFFINITY_PROVIDER_VALIDATION.getValue());
