...
public class ProviderInfoConstants {
	...
	public static final String MBR_MCID_LABEL = "MCID";
	public static final String PIMS_RANK_LABEL = "RANKG_ORDR_NBR";
	...
	public static final String PCP_RANKG_ID_LABEL = "MDO_RANKING";
	
	public static final String PANEL_CAPACITY_LABEL = "PANEL_CAPACITY";
	public static final String AERIAL_DIST_LABEL = "AERIAL_DIST";
