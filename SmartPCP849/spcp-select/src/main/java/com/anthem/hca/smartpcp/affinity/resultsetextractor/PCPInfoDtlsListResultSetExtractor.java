...
public class PCPInfoDtlsListResultSetExtractor implements ResultSetExtractor<List<Provider>> {
	...
	public List<Provider> extractData(ResultSet resultSet) throws SQLException {
		...
		while (resultSet.next()) {
			...
			provider.setMemberMcid(resultSet.getString(ProviderInfoConstants.MBR_MCID_LABEL));
			...
			provider.setRank(Integer.parseInt(resultSet.getString(ProviderInfoConstants.PIMS_RANK_LABEL)));
			provider.setDummyFlag(false);
