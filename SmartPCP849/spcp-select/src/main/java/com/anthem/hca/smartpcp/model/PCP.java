...
public class PCP {
	...
	@ApiModelProperty(notes = "Contains specialty of the assigned PCP")
	 ...
	 *            the pcpScore to set
	 */
	public void setPcpScore(Integer pcpScore) {
	 ...
	 *            the pcpRank to set
	 */
	public void setPcpRank(Integer pcpRank) {
