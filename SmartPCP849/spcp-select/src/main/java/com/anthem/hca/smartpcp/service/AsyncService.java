...
public class AsyncService {
	...
	@Async
	public void asyncMemberUpdate(Member member,  Timestamp dateTime) {
		try {
			String traceId = tracer.getCurrentSpan().traceIdString();
			memberHistRepo.updateMember(member, traceId, dateTime);
	...
	@Async
	public void asyncMemberInsert(Member member, Timestamp dateTime) {
		try {

			String traceId = tracer.getCurrentSpan().traceIdString();
			memberHistRepo.insertMember(member, traceId,dateTime);
