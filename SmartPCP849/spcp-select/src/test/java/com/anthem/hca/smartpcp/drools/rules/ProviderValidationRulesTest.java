...
public class ProviderValidationRulesTest {
	...
	@Test
	public void testSetContractCushionPeriod() throws DroolsParseException {
		rules.setContractCushionPeriod("30");
		assertEquals(30, rules.getContractCushionPeriod());
	}

	@Test
	public void testSetContractCushionPeriodThrowsException() {
		try {
			rules.setContractCushionPeriod(null);
			fail("Expected an DroolsParseException to be thrown");
		} catch (DroolsParseException dpe) {
			assertThat(dpe.getMessage(), containsString("cannot be empty"));
		}
		...
		try {
			rules.setContractCushionPeriod("");
			fail("Expected an DroolsParseException to be thrown");
		} catch (DroolsParseException dpe) {
			assertThat(dpe.getMessage(), containsString("cannot be empty"));
		}
		...
		try {
			rules.setContractCushionPeriod("FOO");
			fail("Expected an DroolsParseException to be thrown");
		} catch (DroolsParseException dpe) {
			assertThat(dpe.getMessage(), containsString("FOO"));
		}
	...
	@Test
	public void testSetDistance() throws DroolsParseException {
		rules.setDistance("60");
		assertEquals(60, rules.getDistance());
	}

	@Test
	public void testSetDistanceThrowsException() {
		try {
			rules.setDistance(null);
			fail("Expected an DroolsParseException to be thrown");
		} catch (DroolsParseException dpe) {
			assertThat(dpe.getMessage(), containsString("cannot be empty"));
		}
