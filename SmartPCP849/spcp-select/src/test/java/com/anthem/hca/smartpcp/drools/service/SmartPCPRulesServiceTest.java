...
public class SmartPCPRulesServiceTest {

	@InjectMocks
	private SmartPCPRulesService spService;
	...
	public void setupMock() {
		...
		ReflectionTestUtils.setField(spService, "approach", 1);
	}
	...
	public void testGetRules() throws Exception {
		...
		out.setRules(spService.getRules(m));
