...
import com.anthem.hca.smartpcp.validator.ORNotBlank;
...
public class Member {
	...
	@NotBlank(message = ErrorMessages.MISSING_REQUEST_TYPE)
	@Size(max = 1, message = ErrorMessages.INVALID_REQUEST_TYPE)
	@Pattern(regexp = "[a-z-A-Z]*", message = ErrorMessages.INVALID_REQUEST_TYPE)
	...
	@Size(max = 5, message = ErrorMessages.INVALID_MBR_SOURCE_SYSTEM)
	@ApiModelProperty( dataType = "String", notes = "Contains the source system(WGS or ISG),,max size = 5")
	private String memberSourceSystem;

	@NotBlank(message = ErrorMessages.MISSING_MBR_PRODUCT)
	@Size(max = 10, message = ErrorMessages.INVALID_MBR_PRODUCT)
	...
	@Size(max = 1, message = ErrorMessages.INVALID_MBR_MIDDLE_NAME)
	@ApiModelProperty(dataType = "String", notes = "Contains the middle name of the member,max size = 1")
	private String memberMiddleName;

	@Size(max = 40, message = ErrorMessages.INVALID_MBR_LAST_NAME)
	...
	@Max(value = 99999999, message = ErrorMessages.INVALID_MBR_GROUP_ID)
	@ApiModelProperty(dataType = "Integer", notes = "Contains the group ID of the member,max value = 99999999")
	private Integer memberGroupId;

	@Max(value = 9999, message = ErrorMessages.INVALID_MBR_SUB_GROUP_ID)
