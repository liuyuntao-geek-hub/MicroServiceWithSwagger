#!/bin/sh
#=================================================================================================================================================
# Title            : Product_WRAPPER
# ProjectName      : 849 SMARTPCP select
# Filename         : PRODUCT_Wrapper.sh
...
echo "PRODUCT wrapper triggered at $now" >>$SPCP_LOG_FILE
if [ $# -eq 2 ]
    then
