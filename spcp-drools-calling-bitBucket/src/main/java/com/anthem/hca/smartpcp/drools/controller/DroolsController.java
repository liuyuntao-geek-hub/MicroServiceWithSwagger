...
public class DroolsController {
	...
	public SmartPCPRulesOutputPayload getRequestForSmartPCP(@ApiParam(value = "Member Input Payload for Business Rules Engine", required = true) @Validated @RequestBody RulesInputPayload ipPayload) throws DroolsParseException, JsonProcessingException {
		...
		opPayload.setResponseMessage("SmartPCP Rules successfully applied on Payload");

		logger.info("SmartPCP Rules successfully applied on Payload");
	...
	public ProviderValidationRulesOutputPayload getRequestForProviderValidationAffinity(@ApiParam(value = "Member Input Payload for Business Rules Engine", required = true) @Validated @RequestBody RulesInputPayload ipPayload) throws DroolsParseException, JsonProcessingException {
		...
		opPayload.setResponseCode(ResponseCodes.SUCCESS);
		opPayload.setResponseMessage("Affinity Provider Validation Rules successfully applied on Payload");

		logger.info("Affinity Provider Validation Rules successfully applied on Payload");
	...
	public ProviderValidationRulesOutputPayload getRequestForProviderValidationMDO(@ApiParam(value = "Member Input Payload for Business Rules Engine", required = true) @Validated @RequestBody RulesInputPayload ipPayload) throws DroolsParseException, JsonProcessingException {
		...
		opPayload.setResponseCode(ResponseCodes.SUCCESS);
		opPayload.setResponseMessage("MDO Provider Validation Rules successfully applied on Payload");

		logger.info("MDO Provider Validation Rules successfully applied on Payload");
	...
	public MDOPoolingRulesOutputPayload getRequestForMDOPooling(@ApiParam(value = "Member Input Payload for Business Rules Engine", required = true) @Validated @RequestBody RulesInputPayload ipPayload) throws DroolsParseException, JsonProcessingException {
		...
		opPayload.setResponseCode(ResponseCodes.SUCCESS);
		opPayload.setResponseMessage("MDO Pooling Rules successfully applied on Payload");

		logger.info("MDO Pooling Rules successfully applied on Payload");
	...
	public MDOScoringRulesOutputPayload getRequestForMDOScoring(@ApiParam(value = "Member Input Payload for Business Rules Engine", required = true) @Validated @RequestBody RulesInputPayload ipPayload) throws DroolsParseException, JsonProcessingException {
		...
		opPayload.setResponseCode(ResponseCodes.SUCCESS);
		opPayload.setResponseMessage("MDO Scoring Rules successfully applied on Payload");

		logger.info("MDO Scoring Rules successfully applied on Payload");
