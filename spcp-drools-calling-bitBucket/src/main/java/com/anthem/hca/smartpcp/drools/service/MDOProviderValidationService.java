...
public class MDOProviderValidationService implements IRulesService {
	...
	private static final Logger logger = LogManager.getLogger(MDOProviderValidationService.class);
	...
	public ProviderValidationRules getRules(RulesInputPayload payload) throws DroolsParseException, JsonProcessingException {
		...
		ProviderValidationRules rules = (ProviderValidationRules)droolsService.fireRulesFor(AgendaGroup.MDO_PROVIDER_VALIDATION, payload, fallback);
