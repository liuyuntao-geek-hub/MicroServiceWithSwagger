...
public class MDOPoolingServiceTest {
	...
	public void testGetRules() throws Exception {
		...
		MDOPoolingRules r = createMDOPoolingRule(ipPayload.getMember());
	...
	public void testGetFallbackRules() throws Exception {
		...
		MDOPoolingRules r = createDefaultRule();
	...
	public MDOPoolingRules createMDOPoolingRule(Member member) {
		MDOPoolingRules r = new MDOPoolingRules();
	...
	public MDOPoolingRules createDefaultRule() {
		MDOPoolingRules r = new MDOPoolingRules();
		r.setMarket("ALL");
		r.setLob("ALL");
		r.setProduct("ALL");
