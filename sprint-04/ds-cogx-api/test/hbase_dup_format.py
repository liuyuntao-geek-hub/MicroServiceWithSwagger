...
df_his_dtl = pd.read_csv("../sample/dup/history_detail.txt",dtype=str,converters={'CLM_CMPLTN_DT':to_datetime,'SRVC_FROM_DT_DTL':to_datetime,'SRVC_TO_DT_DTL':to_datetime},index_col=None)
df_his_hdr = pd.read_csv("../sample/dup/history_header.txt",dtype=str,converters={'CLM_CMPLTN_DT':to_datetime,'SRVC_FROM_DT':to_datetime,'SRVC_THRU_DT':to_datetime},index_col=None)
